...
struct Convert: ParsableCommand {
    ...
    private func performDryRun(
        ...
        print("   Header Region: \(config.processing.pageHeaderRegion)")
        print("   Footer Region: \(config.processing.pageFooterRegion)")
...
struct Validate: ParsableCommand {
    ...
    private func printConfigurationDetails(config: MDKitConfig, indent: String) {
        ...
        print("\(indent)  - Header Region: \(config.processing.pageHeaderRegion)")
        print("\(indent)  - Footer Region: \(config.processing.pageFooterRegion)")
        print("")
        print("\(indent)Output:")
